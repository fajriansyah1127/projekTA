...
class iterasi2 extends TestCase
{
    ...
    {
        $user = User::where('role','Admin')->first();
        $response = $this->actingAs($user)->delete(route('asuransi.destroy',13));
        $response->assertStatus(302);
    }
    ...
    {
        $user = User::where('role','Admin')->first();
        $response = $this->actingAs($user)->delete(route('produk.destroy','13'));
        $response->assertStatus(302);
    }
    ...
    {
        $user = User::where('role','Admin')->first();
        $response = $this->actingAs($user)->delete(route('outlet.destroy','9'));
        $response->assertStatus(302);
    }
