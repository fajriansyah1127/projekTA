                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content bg-default">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('asuransi.update', $data->id) }}"
                                ...
                                <input type="tel" id="kontak" name="kontak"
                                    class="form-control" placeholder="Contoh 0542"
                                    required value="{{ $data->kontak }}">
                                ...
                                <select id="disabledSelect" name="status"
                                    ...
                                    <option value="Berlaku"
                                        {{ $data->status == 'Berlaku' ? 'selected' : '' }}>
                                        Berlaku </option>
                                    <option value="Tidak Berlaku"
                                        {{ $data->status == 'Tidak Berlaku' ? 'selected' : '' }}>
                    ...
                    <div class="modal-content bg-default">
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn  btn-sm btn-primary"
                                data-dismiss="modal">Close</button>
                            <form action="{{ route('asuransi.destroy', $data->id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
