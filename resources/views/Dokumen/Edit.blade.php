                ...
                <form action="{{ route('dokumen.update',$dokuman->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  @csrf
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                               <input type="text" id="nama" name="Nama" class="form-control" placeholder="Masukkan Nama "required value="{{ $dokuman->nama }}">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                               <input type="number" id="nomor" name="Nomor" class="form-control" placeholder="Masukkan Nomor" required value="{{ $dokuman->nomor_surat}}">  
                          </div>
                        </div>
